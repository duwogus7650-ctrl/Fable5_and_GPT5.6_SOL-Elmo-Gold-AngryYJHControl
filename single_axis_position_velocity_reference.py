...
EVIDENCE_LABEL = (
    ...
    "UM/PA[1]/PR[1]/JV/SP[1]/AC[1]/DC/SD/PX/VX QUERY ONLY / "
    "NO ASSIGNMENT / NO BG / NO ENABLE OR MOTION"
)
REFERENCE_SEMANTICS = (
    "CONFIGURED / QUEUED READBACK - NOT ACTIVE COMMAND OR MOTION PROOF · "
    "2026-07-19 RAW PX MATCHED EAS TERMINAL, BUT EAS SINGLE AXIS DISPLAY "
    "DIFFERED BY 2^25 COUNTS · MISMATCH / NEED-DATA"
)
