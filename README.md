...
> Expert Candidate Lab v2이다. 독립 안전 검토의
...
| **Tuning** | Phase 1/2 식별·설계 후보, installed-gain Verify, connection-bound 커뮤테이션 서명 + no-I/O Expert P1→P2 MODEL | Expert v2 OFFLINE 검증 · 과거 hardware LIVE 이력과 분리 · production gain Apply/Save 잠금 |
